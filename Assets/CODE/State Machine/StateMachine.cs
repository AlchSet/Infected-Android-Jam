...
namespace MyStateMachine
{
    public class StateMachine : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            PatrolState state1 = new PatrolState();
            state1.name = "State 1";
            state1.m = this;

            ChaseState chase1 = new ChaseState();
            chase1.name = "ChasePlayer";
            chase1.m = this;


            //Conditions for TO CHASE
            Condition toChasePlayer = new Condition();
            toChasePlayer.p = parameters[0];
            toChasePlayer.type = Condition.ConditionTypes.TRUE;

            Transition state1ToChase = new Transition();


            state1ToChase.conditions.Add(toChasePlayer);

            state1ToChase.nextState = chase1;


            //CONDITIONS FOR BACK TO STATE1
            Condition toState1 = new Condition();
            toState1.p = parameters[1];
            //toState1.type = Condition.ConditionTypes.FALSE;

            Transition ChaseTOState1 = new Transition();

            ChaseTOState1.nextState = state1;

            ChaseTOState1.conditions.Add(toState1);
            ...
            state1.transitions.Add(state1ToChase);

            chase1.transitions.Add(ChaseTOState1);
